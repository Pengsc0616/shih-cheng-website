      ...
      <div>
        <aside id="aside-container" className="full-height">
          <div id="author-container">
            ...
            <h1 id="author-name">Shih-Cheng Peng</h1>
          ...
          <div id="contact-container">
            <div id="contact-content">
              <a href="https://www.linkedin.com/in/alex-peng-04ab771b4/" target="_blank" className="contact-section fab fa-linkedin" rel="noopener noreferrer"></a>
              <a href="https://github.com/Pengsc0616" target="_blank" className="contact-section fab fa-github-square" rel="noopener noreferrer"></a>
            </div>
          </div>
        </aside>
      </div>
